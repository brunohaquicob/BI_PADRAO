...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      selectedListLabel: 'Selecionados',                                                 // 'string', false
      nonSelectedListLabel: 'Disponiveis',                                               // 'string', false
      ...
      infoTextFiltered: '<span class="badge badge-warning">Filtrados</span> {0} de {1}', // when not all of the options are visible due to the filter
      infoTextEmpty: 'Sem dados',                                                        // when there are no options present in the list
