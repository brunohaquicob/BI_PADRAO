...
(function () {
    ...
    function updateSelect($select) {
        ...
        jQuery('#' + prefix + '-dropdown-text').text(
            selected_count > 0 ? (selected_count == 1 ? selected_count + " selecionado" : "Selecionados") : ""
        ).prop('hidden', !active);
    ...
    jQuery.fn.multiselect = function (options) {
        ...
        return this.each(function () {
            ...
            let max_height = select_options.maxHeight
                ? select_options.maxHeight
                : (
                    ($select.offset().top > 0)
            ...
            if (select_options.fontSize) {
                $dropdown.find('.dropdown-menu').css('font-size', select_options.fontSize);
            }
            ...
            $dropdown.on('show.bs.dropdown', function () {
                ...
                max_height = select_options.maxHeight
                    ? select_options.maxHeight
                    : (
                        ($dropdown.offset().top > 0)
