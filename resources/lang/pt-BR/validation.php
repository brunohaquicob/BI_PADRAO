...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'password' => [
            'regex' => 'A senha deve conter pelo menos uma letra maiúscula, uma letra minúscula e um número.',
        ],
        'situacao_usuario' => [
            'in' => 'O valor informado está incorreto, permitido: Bloqueado, Ativo, Desativado',
        ],
    ],
