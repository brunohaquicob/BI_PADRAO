        ...
        <div class="card-body">
            <form id="form_filtros_pesquisa">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="tem_acordo">Acordos:</label>
                            <select class="form-control" id="tem_acordo" name="tem_acordo" required="true">
                                <option value="A" selected>Ambos</option>
                                <option value="C">Com acordos</option>
                                <option value="S">Sem acordos</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="qtd_clicks">Clicks:</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">Superior a: </span>
                                </div>
                                <input type="number" class="form-control" id="qtd_clicks" name="qtd_clicks" required="true" value="10">
    ...
    @push('js')
        ...
        <script>
            ...
            function __buscarDados() {
                ...
                const requestParams = {
                    method: 'POST',
                    url: '{{ route('buscar.rel_oportunidade_ws') }}',
                    data: {
                        'rangedatas': datas
                    },
                    formId: idForm
                        ...
                        __dashTeste({
                            ...
                            kpis: [{
                                ...
                                },
                                {
                                    renderTo: 'kpi-card2',
                                    title: colunsName[2],
                                    value: formatNumber(dados_grafico.totais[1], 0),
                                ...
                                },
                                {
                                    ...
                                    subtitle: 'Valor disponível para negociar',
                                    valueFormat: '{value}'
                                }
                            ],
                            charts: [{
                                    renderTo: 'dashboard-col-0',
                                    yAxisTitle: 'Clicks (Qtd)',
